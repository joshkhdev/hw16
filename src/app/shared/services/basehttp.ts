...
export class BaseHttp {
    ...
    public getWorker(id: number): Promise<any> {
        return this.get(`${this.path}/${id}`).toPromise();
    }
    public postWorker(data: any): Promise<any> {
        return this.post(`${this.path}`, data).toPromise();
    }
    public putWorker(id: number, data: any): Promise<any> {
        return this.put(`${this.path}/${id}`, data).toPromise();
    }
    public deleteWorker(id: number): Promise<any> {
